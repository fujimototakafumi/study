...
[Command]
name = "RandomViolentRape"
command = B, F, z
time = 20

[Command]
name = "FriendshipPower"
command = F, D, B, z+c
time = 30
...
[State -1, hermaphroditism attack2]
type = ChangeState
value = 89000
triggerall = command = "PMissionary" && statetype != A
triggerall = p2life < 500
trigger1 = ctrl
trigger2 = movecontact

[State -1, hermaphroditism attack2lovely]
type = ChangeState
value = 35000
triggerall = command = "LMissionary" && statetype != A
trigger1 = ctrl
trigger2 = movecontact
...
type = ChangeState
value = 35015
triggerall = command = "LDoggy2" && statetype != A
trigger1 = ctrl
trigger2 = movecontact
...
type = ChangeState
value = 35020
triggerall = command = "LCowgirl" && statetype != A
trigger1 = ctrl
trigger2 = movecontact
...
type = ChangeState
value = 35030
triggerall = command = "RandomRape" && statetype != A
trigger1 = ctrl
trigger2 = movecontact
...
type = ChangeState
value = 35329
triggerall = command = "RandomViolentRape" && statetype != A
...
type = ChangeState
value = 40010
triggerall = command = "FriendshipPower" && statetype != A
;triggerall = power >= 2000
trigger1 = ctrl
trigger2 = movecontact
